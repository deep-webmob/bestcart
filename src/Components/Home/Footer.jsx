    ...
    <footer aria-label="Site Footer" className="bg-white">
      <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="lg:flex lg:items-start lg:gap-8">
          ...
          <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-7 lg:gap-y-16">
              ...
              <form className="w-full">
                ...
                <div className="border border-gray-100 p-2 focus-within:ring sm:flex sm:items-center sm:gap-4">
                  <input
                    ...
                    className="w-full border-white focus:border-transparent focus:ring-transparent sm:text-sm"
                  />
            ...
            <ul className="col-span-2 flex justify-start gap-6 lg:col-span-4 lg:justify-end">
              <li>
                <a
                  href="/"
                  rel="noreferrer"
